...
export const APPS_REGISTRY: AppDefinition[] = [
  ...
  },
  {
    ...
    title: 'Pembelian',
    description: 'Kelola alur pengadaan barang, permintaan, penawaran, pesanan, penerimaan, dan faktur.',
    category: 'inventory',
    categoryLabel: 'Produk & Inventori',
    ...
    badge: { label: 'BOH', tone: 'neutral' },
    keywords: ['pembelian', 'purchase', 'supplier', 'vendor', 'po', 'grn', 'pr', 'invoice', 'faktur', 'penawaran', 'pesanan', 'penerimaan'],
    subLinks: [
      { label: 'Permintaan Dapur', href: '/purchase/requisitions', iconName: 'FileStack', requiredPermission: PERMISSIONS.purchasing.view, keywords: ['pr', 'purchase requisition', 'permintaan', 'dapur', 'stok'] },
      { label: 'Penawaran Harga', href: '/purchase/quotations', iconName: 'FileText', requiredPermission: PERMISSIONS.purchasing.view, keywords: ['rfq', 'quotation', 'penawaran', 'supplier', 'vendor', 'harga'] },
      { label: 'Pesanan Pembelian', href: '/purchase/orders', iconName: 'ClipboardList', requiredPermission: PERMISSIONS.purchasing.create, keywords: ['po', 'purchase order', 'pesanan', 'pembelian'] },
      { label: 'Penerimaan Barang', href: '/purchase/goods-received', iconName: 'PackageCheck', requiredPermission: PERMISSIONS.purchasing.receive, keywords: ['grn', 'goods received note', 'penerimaan', 'terima barang'] },
      { label: 'Faktur Supplier', href: '/purchase/invoices', iconName: 'Receipt', requiredPermission: PERMISSIONS.purchasing.view, keywords: ['invoice', 'faktur', 'tagihan', 'supplier', 'vendor bill'] },
    ],
  },
  {
    id: 'crm',
  ...
  },
  {
    ...
    subLinks: [
      ...
      { label: 'Penomoran Dokumen', href: '/settings/sequences', iconName: 'Hash', requiredPermission: PERMISSIONS.settings.view },
