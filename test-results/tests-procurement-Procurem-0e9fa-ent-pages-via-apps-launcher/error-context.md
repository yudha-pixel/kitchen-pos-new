...
- Name: tests/procurement.spec.ts >> Procurement UI Tests >> Login and access procurement pages via apps launcher
- Location: tests/procurement.spec.ts:9:7
...
- generic [active] [ref=e1]:
  - generic [ref=e3]:
    - generic [ref=e4]:
      - heading "Kitchen POS" [level=1] [ref=e8]
      - paragraph [ref=e9]: Masuk untuk membuka POS
    - generic [ref=e10]:
      - generic [ref=e11]:
